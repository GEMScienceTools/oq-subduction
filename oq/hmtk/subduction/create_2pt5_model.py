...
def get_interpolated_profiles(sps, lengths, number_of_samples):
    ...
    for key in sorted(sps.keys()):
        # Sampling distance
        samp = lengths[key] / number_of_samples * 0.98
        # Data
        dat = sps[key]
...
def read_profiles_csv(foldername, upper_depth=0, lower_depth=1000, from_id=".*",
                        to_id="-999999"):
    """
...
def main(argv):
    ...
    maximum_sampling_distance = argv[1]
