...
def complex_fault_src_from_edges(edges_folder, source_nameid, out_nrml='source.xml'):
    """
    :param edges_folder:
    :param source_nameid
    :param out_nrml:
...
def runner(argv):
    ...
    p.arg(name='source_nameid', help='Unique id for the source')
